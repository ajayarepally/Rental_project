...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      <div className="fixed inset-0 flex items-center justify-center">
        <div className="container mx-auto max-w-md p-6 border rounded-lg shadow-lg bg-white/50 backdrop-blur transition-transform hover:scale-[1.01]">
          ...
          <form onSubmit={submit}>
            ...
            <button
              type="submit"
              className={`w-full py-2 rounded text-white transition-transform hover:scale-[1.02] ${
